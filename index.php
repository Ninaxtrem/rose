...
<head>
  ...
  <link href=https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css%3E> <meta name="viewport"
...
<body>
        ...
        <div class="navbar navbar-expand-lg">
          ...
          <div class="collapse navbar-collapse" id="navbar-content">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="http://localhost/rose/cal">Prise de rendez-vous</a>
              </li>
              <li class="nav-item">
  ...
  <!--Photo-->
  <div class="ongles">
    <h1><img src="assets/img/bg3.jpg" class="img-fluid" alt="Responsive image"></h1>
  </div>
